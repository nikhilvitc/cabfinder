      ...
      <div style={{ backgroundColor: 'white', borderRadius: 12, padding: 24, maxWidth: 640, width: '92%', maxHeight: '80vh', overflow: 'auto' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 }}>
          ...
          <div style={{ display: 'flex', gap: 8 }}>
            <a href="https://forms.gle/jZpA5Ej2QwCkMxD36" target="_blank" rel="noopener noreferrer" style={{ backgroundColor: '#10b981', color: 'white', padding: '8px 12px', borderRadius: 6, textDecoration: 'none' }}>📝 Add Your Travel</a>
